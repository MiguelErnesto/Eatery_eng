...
class Section3_categoriesController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('section3.edit', ['section3' => 1])->with('success', 'Category: "' . $section3_categories->name  . '"  updated successfully.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('section3.edit', ['section3' => 1])->with('success', 'Category: ' . $section3_categories->name . '  deleted successfully.');
    }
}
