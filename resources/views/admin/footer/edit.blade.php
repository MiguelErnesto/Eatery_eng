        ...
        <div class="card border border-dark">
            ...
            <div class="card-body">
                <form id='footer_form' action="{{ route('footer.update', ['footer' => $footer->id]) }}" method="POST"
                    ...
                    <div class="mb-3">
                        <label for="title" class="form-label">Other details:</label>
    ...
    <script>
        ...
        function validarFormulario(evento) {
            ...
            if (document.getElementById('symbol').value.length == 0) {
                ...
                document.getElementById('symbol').placeholder = '--- Required value ---';
            ...
            if (document.getElementById('year').value.length == 0) {
                ...
                document.getElementById('year').placeholder = '--- Required value ---';
            ...
            if (document.getElementById('owner').value.length == 0) {
                ...
                document.getElementById('owner').placeholder = '--- Required value ---';
            ...
            if (document.getElementById('other_details').value.length == 0) {
                ...
                document.getElementById('other_details').placeholder = '--- Required value ---';
            ...
            if (document.getElementById('name_link').value.length == 0) {
                ...
                document.getElementById('name_link').placeholder = '--- Required value ---';
            ...
            if (document.getElementById('link').value.length == 0) {
                ...
                document.getElementById('link').placeholder = '--- Required value ---';
