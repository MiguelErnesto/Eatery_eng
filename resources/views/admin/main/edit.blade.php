        ...
        <div class="card border border-dark">
            ...
            <div class="card-body">
                <form id='main_form' action="{{ route('main.update', ['main' => $main->id]) }}" method="POST">
                    ...
                    <div class="mb-3">
                        <label for="title" class="form-label"><strong>Primary Name: </strong></label>
                    ...
                    <div class="mb-3">
                        <label for="title" class="form-label"><strong>Secondary Name: (optional)</strong></label>
    ...
    <script>
        ...
        function validarFormulario(evento) {
            ...
            if (document.getElementById('name1').value.length == 0) {
                ...
                document.getElementById('name1').placeholder = '--- Required value ---';
