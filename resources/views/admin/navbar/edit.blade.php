    ...
    <script>
        ...
        function validarFormulario(evento) {
            ...
            if (document.getElementById('item1').value.length == 0) {
                ...
                document.getElementById('item1').placeholder = '--- Required value ---';
            ...
            if (document.getElementById('item2').value.length == 0) {
                ...
                document.getElementById('item2').placeholder = '--- Required value ---';
            ...
            if (document.getElementById('item3').value.length == 0) {
                ...
                document.getElementById('item3').placeholder = '--- Required value ---';
            ...
            if (document.getElementById('item4').value.length == 0) {
                ...
                document.getElementById('item4').placeholder = '--- Required value ---';
            ...
            if (document.getElementById('item5').value.length == 0) {
                ...
                document.getElementById('item5').placeholder = '--- Required value ---';
            ...
            if (document.getElementById('item6').value.length == 0) {
                ...
                document.getElementById('item6').placeholder = '--- Required value ---';
            ...
            if (document.getElementById('item7').value.length == 0) {
                ...
                document.getElementById('item7').placeholder = '--- Required value ---';
