    ...
    <div class="container w-75 p-4">
        <div class="card border border-dark">
            <div class="card-header bg-dark">
                <h5>{{ config('app.nav_section1') }} &nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp; New </h5>
            </div>
                ...
                <form id="section1_form" action="{{ route('section1.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="input-group">
                        ...
                        <div class="mb-3 mr-5 p-3">
                            <label for="title" class="form-label">Label button: </label>
                        ...
                        <div class="mb-3 ml-5 p-3">
                            <label for="title" class="form-label">Link section: </label>
    ...
    <script>
        ...
        function validarFormulario(evento) {
            ...
            if (document.getElementById('small_text').value.length == 0) {
                ...
                document.getElementById('small_text').placeholder = '--- Required value ---';
            ...
            if (document.getElementById('large_text').value.length == 0) {
                ...
                document.getElementById('large_text').placeholder = '--- Required value ---';
            ...
            if (document.getElementById('lb_button').value.length == 0) {
                ...
                document.getElementById('lb_button').placeholder = '--- Required value ---';
            ...
            if (document.getElementById('link_button').value.length == 0) {
                ...
                document.getElementById('link_button').placeholder = '--- Required value ---';
            ...
            if (document.getElementById('image').value.length == 0) {
                ...
                document.getElementById('err_image').value = '--- Required value ---';
