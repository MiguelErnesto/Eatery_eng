            ...
            <div class="card-body">
                ...
                <form id="section3_form" action="{{ route('section3.update', ['section3' => $section3->id]) }}" method="POST"
                    ...
                    <div class="input-group">
                        ...
                        <div class="mb-3 ml-4">
                            <label for="title" class="form-label text-white">Action: </label><br />
                    ...
                    <table class="table">
                        <thead>
                            <tr class="bg-light table-sm">
                                ...
                                <th scope="col"></th>
                                <th scope="col" class="text-center">Social Networks</th>
                                <th scope="col"></th>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        <form action="{{ route('section3_imgs.destroy', [$section3_img->id]) }}"
                                            ...
                                            @csrf
                                            <button class="btn btn-link"
                                                onclick="return confirm('Are yo sure to delete: {{ $section3_img->name }}? All elements asociated whit this will be deleted too.')">
