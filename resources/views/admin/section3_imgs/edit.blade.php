    ...
    <div class="container w-75 p-4">
        <div class="card border border-dark">
            <div class="card-header bg-dark">
                <h5>{{ config('app.nav_section3') }} &nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp; Edit </h5>
            </div>
            <div class="card-body">
                ...
                <form id="section3_imgs_form"
                    ...
                    <div class="mb-5 mr-3 ml-3">
                        <label for="title" class="form-label">Social Networks text: </label>
                    ...
                    <table class="table">
                        <thead>
                            <tr class="bg-light table-sm">
                                <th scope="col"></th>
                                <th scope="col"></th>
                                <th scope="col" class="text-center">{{ $section3_imgs->name }} - Social Networks </th>
                                <th scope="col"></th>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        <form
                                            ...
                                            @csrf
                                            <button class="btn btn-link"
                                                onclick="return confirm('Are yo sure to delete {{ $social_network->name }}?')">
    ...
    <script>
        ...
        function validarFormulario(evento) {
            ...
            if (document.getElementById('role').value.length == 0) {
                ...
                document.getElementById('role').placeholder = '--- Required value ---';
            ...
            if (document.getElementById('text_social_networks').value.length == 0) {
                ...
                document.getElementById('text_social_networks').placeholder = '--- Required value ---';
