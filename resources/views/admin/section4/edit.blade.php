            ...
            <div class="card-body">
                <form id="section4_form" action="{{ route('section4.update', ['section4' => $section4->id]) }}" method="POST"
                    ...
                    <div class="input-group">
                        ...
                        <div class="mr-2">
                            <label for="title" class="form-label"><strong>Description:
                                </strong></label>
                        ...
                        <div>
                            <label for="title" class="form-label"><strong>Testimonials Background:
                    ...
                    <table class="table">
                        <thead>
                            <tr class="bg-light table-sm">
                                <th scope="col"></th>
                                <th scope="col" class="text-center"> Testimonials</th>
                                <th scope="col"> </th>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        <form
                                            ...
                                            @csrf
                                            <button class="btn btn-link"
                                                onclick="return confirm('Are you sure to delete this testimonial ({{ $section4_testimonial->name }})?')">
                    ...
                    <table class="table">
                        <thead>
                            <tr class="bg-light table-sm">
                                ...
                                <th scope="col" class="text-center">Text Popup</th>
                                <th scope="col"> </th>
                                <th scope="col" class="bg-dark text-center">
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        <form action="{{ route('section4_images.destroy', [$section4_image->id]) }}"
                                            ...
                                            @csrf
                                            <button class="btn btn-link"
                                                onclick="return confirm('Are you sure to delete {{ $section4_image->title }}?')">
                                                <i class="fa fa-trash fa-lg" style="color:#f16d6d"></i>
                                            </button>
                                        </form>
                                    </td>
    ...
    <script>
        ...
        function validarFormulario(evento) {
            ...
            if (document.getElementById('title').value.length == 0) {
                ...
                document.getElementById('title').placeholder = '--- Required value ---';
                document.getElementById('title').focus();
                return;
            }
            if (document.getElementById('description').value.length == 0) {
                document.getElementById('description').className = 'form-control border border-danger';
                document.getElementById('description').placeholder = '--- Required value ---';
