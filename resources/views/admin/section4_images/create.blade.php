    ...
    <div class="container w-75 p-4">
        <div class="card border border-dark">
            <div class="card-header bg-dark">
                <h5>{{ config('app.nav_section4') }} &nbsp;&nbsp;&nbsp;/ &nbsp;&nbsp;&nbsp;Gallery &nbsp;&nbsp;&nbsp;/
                    &nbsp;&nbsp;&nbsp;New Image</h5>
            </div>
            ...
            <div class="card-body">
                <form id="section4_images_form" action="{{ route('section4_images.store') }}" method="POST"
                    ...
                    <div class="input-group mb-3">
                        <div class="mb-3 mr-5">
                            <label for="title" class="form-label">Text popup: </label>
                        ...
                        <div class="mb-3 ml-5">
                            <label for="title" class="form-label">Price:</label>&nbsp;&nbsp;&nbsp;<span>$</span>
                            <input type="text" id="price" name="price" class="form-control w-50" value="">
                            @error('price')
                                <div class="text-danger text-center">Numeric value required</div>
                            @enderror
                        </div>
    ...
    <script>
        ...
        function validarFormulario(evento) {
            ...
            if (document.getElementById('text_popup').value.length == 0) {
                ...
                document.getElementById('text_popup').placeholder = '--- Required value ---';
