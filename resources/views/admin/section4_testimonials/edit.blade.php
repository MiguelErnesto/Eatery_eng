    ...
    <div class="container w-75 p-4">
        <div class="card border border-dark">
            <div class="card-header bg-dark">
                <h5>{{ config('app.nav_section4') }} / Testimonials / {{ $section4_testimonials->name }}</h5>
            </div>
            ...
            <div class="card-body">
                <form id="section4_testimonials_form"
                    ...
                    <div class="mb-3">
                        <label for="title" class="form-label">Testimonial: </label><br />
    ...
    <script>
        ...
        function validarFormulario(evento) {
            ...
            if (document.getElementById('name_description').value.length == 0) {
                ...
                document.getElementById('name_description').placeholder = '--- Required value ---';
            ...
            if (document.getElementById('testimonial_text').value.length == 0) {
                ...
                document.getElementById('testimonial_text').placeholder = '--- Required value ---';
