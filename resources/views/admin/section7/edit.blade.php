    ...
    <div class="container w-75 p-4">
        <div class="card border border-dark">
            <div class="card-header bg-dark">
                <h5> {{ config('app.nav_section7') }} &nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp; Edit </h5>
            </div>
            ...
            <div class="card-body">
                <form id="section7_form" action="{{ route('section7.update', ['section7' => $section7->id]) }}" method="POST"
                    ...
                    <div class="container bg-light border border-dark">
                        ...
                        <div class="input-group">
                            <div class="mb-3 ml-5 mr-4">
                                <label for="title" class="form-label">Days: </label>
                        ...
                        <div class="input-group">
                            <div class="mb-3 ml-5 mr-4">
                                <label for="title" class="form-label">Other days: </label>
                            ...
                            <div class="mb-3 ml-5">
                                <label for="title" class="form-label">Other hours: </label>
                        ...
                        <div class="p-3 mr-4 ml-4">
                            <label for="title" class="form-label">Closed: </label>
                        ...
                        <div class="p-3 mr-4 ml-4">
                            <label for="title" class="form-label">Current background image: </label>
                        </div>
    ...
    <script>
        ...
        function validarFormulario(evento) {
            ...
            if (document.getElementById('fu_description').value.length == 0) {
                ...
                document.getElementById('fu_description').placeholder = '--- Required value ---';
            ...
            if ((document.getElementById('rv_number1').value.length == 0) || !((
                ...
                document.getElementById('rv_number1').placeholder = '--- A valid telephone number required ---';
            ...
            if ((document.getElementById('rv_number2').value.length == 0) || !((
                ...
                document.getElementById('rv_number2').placeholder = '--- A valid telephone number required ---';
            ...
            if ((document.getElementById('rv_number2').value.length == 0) || !((
                ...
                document.getElementById('rv_email').placeholder = '--- A valid email required ---';
            ...
            if (document.getElementById('rv_text').value.length == 0) {
                ...
                document.getElementById('rv_text').placeholder = '--- Required value ---';
            ...
            if (document.getElementById('oh_closed').value.length == 0) {
                ...
                document.getElementById('oh_closed').placeholder = '--- Required value ---';
            ...
            if (document.getElementById('oh_days1').value.length == 0) {
                ...
                document.getElementById('oh_days1').placeholder = '--- Required value ---';
            ...
            if (document.getElementById('oh_hours1').value.length == 0) {
                ...
                document.getElementById('oh_hours1').placeholder = '--- Required value ---';
            ...
            if (document.getElementById('oh_days2').value.length == 0) {
                ...
                document.getElementById('oh_days2').placeholder = '--- Required value ---';
            ...
            if (document.getElementById('oh_hours2').value.length == 0) {
                ...
                document.getElementById('oh_hours2').placeholder = '--- Required value ---';
