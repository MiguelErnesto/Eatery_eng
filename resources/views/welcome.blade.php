                    ...
                    <div class="col-md-6 col-sm-12">
                        ...
                        <form id="email_form" action="{{ route('send_contact_email') }}" method="POST"
                            ...
                            <div class="col-md-12 col-sm-12">
                                ...
                                <textarea class="form-control" rows="6" id="message" name="message" placeholder="Tell about your project"></textarea>
                                @error('message')
                                    <script>
                                        document.location.href = "#contact"
                                    </script>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-8" id="reservation">
                        ...
                        <form id="reservation_form" action="{{ route('reservation.store') }}" method="POST">
                            ...
                            <br />
                            <input type="submit" class="btn-danger form-control" value="Reserve">
                        </form>
                    </div>
    @endif
    ...
    <script>
        ...
        function validarFormulario(evento) {
            ...
            if (document.getElementById('name').value.length == 0) {
                ...
                document.getElementById('name').placeholder = '--- Required value ---';
            ...
            if ((document.getElementById('email').value.length == 0) || !((
                ...
                document.getElementById('email').placeholder = '--- A valid email required ---';
            ...
            if (document.getElementById('subject').value.length == 0) {
                ...
                document.getElementById('subject').placeholder = '--- Required value ---';
            ...
            if (document.getElementById('message').value.length == 0) {
                ...
                document.getElementById('message').placeholder = '--- Required value ---';
